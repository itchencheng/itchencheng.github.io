...
module.exports = Analyzer = (function() {
  ...
  Analyzer.prototype.analyze = function(net) {
    var aspect_ratios, d, dilation, dim_in, failed, feature_map, group, hTmp, hTmp2, hTmp3, i, infered_dim, isglobal, j, k, kernel, kernel_h, kernel_w, key, l, layertype, len, len1, len2, len3, mem, mode, module, n, newshape, num_inputs, num_ops, num_priors, num_region_proposals, numout, op, ops, p, pad_beg, pad_end, pad_h, pad_w, params, parent, parent2, permutation, pooltype, prod_in_dims, prod_out_dims, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref22, ref23, ref24, ref25, ref26, ref27, ref28, ref29, ref3, ref30, ref31, ref32, ref33, ref34, ref35, ref36, ref37, ref38, ref39, ref4, ref40, ref41, ref42, ref43, ref44, ref45, ref46, ref47, ref48, ref49, ref5, ref50, ref51, ref52, ref53, ref54, ref55, ref56, ref57, ref6, ref7, ref8, ref9, roi_proposals, settings, shape, shrink, size, stride_h, stride_w, summary, trivial_layers, val, wTmp, wTmp2, wTmp3, zoom;
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      switch (layertype) {
        ...
        case "interp":
          ...
          zoom = (ref16 = params.zoom_factor) != null ? ref16 : 1;
          shrink = (ref17 = params.shrink_factor) != null ? ref17 : 1;
          pad_beg = (ref18 = params.pad_beg) != null ? ref18 : 0;
          pad_end = (ref19 = params.pad_end) != null ? ref19 : 0;
          wTmp = d.wIn + pad_beg + pad_end;
          hTmp = d.hIn + pad_beg + pad_end;
          wTmp2 = wTmp + (wTmp - 1) * (zoom - 1);
          hTmp2 = hTmp + (hTmp - 1) * (zoom - 1);
          wTmp3 = Math.floor((wTmp2 - 1) / shrink) + 1;
          hTmp3 = Math.floor((hTmp2 - 1) / shrink) + 1;
          d.wOut = (ref20 = params.width) != null ? ref20 : wTmp3;
          d.hOut = (ref21 = params.height) != null ? ref21 : hTmp3;
          d.chOut = d.chIn;
          d.comp.macc = d.wOut * d.hOut * d.chOut * d.batchOut;
          break;
        case "pooling":
          params = n.attribs.pooling_param;
          kernel_w = (ref22 = params.kernel_w) != null ? ref22 : params.kernel_size;
          kernel_h = (ref23 = params.kernel_h) != null ? ref23 : params.kernel_size;
          stride_w = (ref24 = params.stride_w) != null ? ref24 : (ref25 = params.stride) != null ? ref25 : 1;
          stride_h = (ref26 = params.stride_h) != null ? ref26 : (ref27 = params.stride) != null ? ref27 : 1;
          pad_w = (ref28 = params.pad_w) != null ? ref28 : (ref29 = params.pad) != null ? ref29 : 0;
          pad_h = (ref30 = params.pad_h) != null ? ref30 : (ref31 = params.pad) != null ? ref31 : 0;
          isglobal = (ref32 = params.global_pooling) != null ? ref32 : 0;
          pooltype = ((ref33 = params.pool) != null ? ref33 : 'MAX').toUpperCase();
          d.chOut = d.chIn;
        ...
        case "lrn":
        case "normalize":
          mode = (ref34 = (ref35 = n.attribs.lrn_param) != null ? ref35.norm_region : void 0) != null ? ref34 : 'ACROSS_CHANNELS';
          size = (ref36 = (ref37 = n.attribs.lrn_param) != null ? ref37.local_size : void 0) != null ? ref36 : 1;
          d.wOut = d.wIn;
          d.hOut = d.hIn;
          d.chOut = d.chIn;
        ...
        case "concat":
          ...
          d.chIn = 0;
          ref38 = n.parents;
          for (j = 0, len1 = ref38.length; j < len1; j++) {
            p = ref38[j];
            d.chIn += p.analysis.chOut;
          }
          d.chOut = d.chIn;
          ref39 = n.parents;
          for (k = 0, len2 = ref39.length; k < len2; k++) {
            p = ref39[k];
        ...
        case "eltwise":
          ...
          failed = false;
          ref40 = n.parents;
          for (l = 0, len3 = ref40.length; l < len3; l++) {
            p = ref40[l];
          ...
          op = (ref41 = (ref42 = n.eltwise_param) != null ? (ref43 = ref42.operation) != null ? ref43.toUpperCase() : void 0 : void 0) != null ? ref41 : 'SUM';
          if (op === 'SUM') {
            d.comp.add = d.wIn * d.hIn * d.chIn * d.batchOut;
          } else if (op === 'MAX') {
            d.comp.comp = d.wIn * d.hIn * d.chIn * d.batchOut;
        ...
        case "deconvolution":
          params = n.attribs.convolution_param;
          kernel_w = (ref44 = params.kernel_w) != null ? ref44 : params.kernel_size;
          kernel_h = (ref45 = params.kernel_h) != null ? ref45 : params.kernel_size;
          stride_w = (ref46 = params.stride_w) != null ? ref46 : (ref47 = params.stride) != null ? ref47 : 1;
          stride_h = (ref48 = params.stride_h) != null ? ref48 : (ref49 = params.stride) != null ? ref49 : 1;
          pad_w = (ref50 = params.pad_w) != null ? ref50 : (ref51 = params.pad) != null ? ref51 : 0;
          pad_h = (ref52 = params.pad_h) != null ? ref52 : (ref53 = params.pad) != null ? ref53 : 0;
          numout = params.num_output;
        ...
        case "scale":
          ...
          break;
        case "implicit":
          d.wIn = (ref54 = d.wIn) != null ? ref54 : "?";
          d.hIn = (ref55 = d.hIn) != null ? ref55 : "?";
          d.chIn = (ref56 = d.chIn) != null ? ref56 : "?";
          d.batchIn = (ref57 = d.batchIn) != null ? ref57 : "?";
          d.wOut = d.wIn;
          d.hOut = d.hIn;
          d.chOut = d.chIn;
          d.batchOut = d.batchIn;
