    ...
    analyze: (net) ->
        ...
        for n in net.sortTopologically()
            ...
            switch layertype
                ...
                #===========================================
                # add interp layer, chencheng 20171016
                #===========================================
                when "interp"
                    #dimensions
                    params = n.attribs.interp_param
                    zoom = params.zoom_factor ? 1
                    shrink = params.shrink_factor ? 1
                    ...
                    d.wOut = params.width ? wTmp3
                    d.hOut = params.height ? hTmp3
                    d.chOut = d.chIn
                    #computations
                ...
                #===========================================
                # add relu layer, chencheng 20171016
                #===========================================              
                when "prelu"
                    #dimensions
                    d.wIn = parent.wOut
                ...
                #===========================================
                # add sigmoid layer, chencheng 20171016, ok
                #===========================================              
                when "sigmoid"
                    #dimensions
                    d.wIn = parent.wOut
